...
def index(request):
    ...
    context = {'TotalCount': TotalCount, 'maxVal': maxVal, 'logVals': logVals, 'dataForMapGraph': dataForMapGraph,
               'countryName': countryName, 'countryValue': countryValue, 'dataForMap': dataForMap}
